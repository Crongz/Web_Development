...
urlpatterns = [
    ...
    url(r'^delete/post/(?P<entry_id>\d+)/$','blog.views.delete_post'),
    url(r'^update/post/(?P<entry_id>\d+)/$','blog.views.update_post'), 
    url(r'^update/post/complete/','blog.views.update_post_complete'),
